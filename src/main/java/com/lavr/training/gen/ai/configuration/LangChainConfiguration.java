...
public class LangChainConfiguration {
    ...
    @Value("${client-openai-key}") String openAIKey;
    ...
    @Bean
    public EmbeddingStoreIngestor ingestor(final EmbeddingModel embeddingModel,
    ...
    @Bean
    public EmbeddingStoreLoggingRetriever storeLoggingRetriever(EmbeddingStoreContentRetriever contentRetriever) {
        return new EmbeddingStoreLoggingRetriever(contentRetriever);
    }

    @Bean
    public ConversationalRetrievalChain chain(final OpenAIClient openAIClient,
                                              final EmbeddingStoreLoggingRetriever storeLoggingRetriever) {
